...
public interface SessionManager extends AutoCloseable {
    ...
    /**
     * Open new session which obtain new {@link ru.saidgadjiev.ormnext.core.support.DatabaseConnection} from
     * {@link ru.saidgadjiev.ormnext.core.support.ConnectionSource} as needed to perform requested work.
