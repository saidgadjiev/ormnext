...
public class DefaultEntityLoader {
    ...
    public DefaultEntityLoader(InternalDao dao) {
        this.dao = dao;
    ...
    private List<Object> load(RowReader rowReader, InternalDao dao, OrmNextResultSet databaseResults) throws SQLException {
