...
import ru.said.miami.orm.core.cache.core.field.ManyToOne;
import ru.said.miami.orm.core.cache.core.field.OneToOne;
...
public class QueryVisitorImpl implements QueryVisitor {
    ...
    @Override
    public void start(SelectQuery selectQuery) {
